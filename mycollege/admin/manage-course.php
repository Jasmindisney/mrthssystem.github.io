...
if (strlen($_SESSION['aid']==0)) {
  ...
  {
    $rowid=$_GET['delid'];
    $query=mysqli_query($con,"delete from tblgradelevels where ID='$rowid'");
...
<head>
  ...
  <title>MARTMHS || Manage Course</title>
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manage Grade Levels
                </li>
...
<table class="table mb-0">
 <thead>
               ...
               <?php
$ret=mysqli_query($con,"select * from tblgradelevels");
$cnt=1;
