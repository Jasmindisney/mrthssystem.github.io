...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblgradelevels(CourseName) value('$coursename')");
    if ($query) {
...
<head>
  <title>MRTHS || Add Grade Level</title>
...
<form name="course" method="post" >        
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Grade Level</h4>
                </div>
  ...
  <div class="row">
                      <div class="col-xl-6 col-lg-12">
                        <fieldset>
                          <h5>Grade Level and Strand (if any)
                          </h5>
