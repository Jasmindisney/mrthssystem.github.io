...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update  tblgradelevels set CourseName = '$coursename' where ID=$eid");
    if ($query) {
...
<head>
  ...
  <title>MRTHS || Update Course</title>
...
<form name="course" method="post" >        
   ...
   <?php
 $cid=$_GET['editid'];
$ret=mysqli_query($con,"select * from tblgradelevels where ID='$cid'");
$cnt=1;
