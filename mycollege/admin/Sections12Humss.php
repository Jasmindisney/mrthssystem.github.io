...
<table class="table mb-0">
 <thead>
            ...
            tbldocument on tbldocument.UserId=tbladmapplications.UserID where tbladmapplications.Section='HUMSS 12-A'");
            $cnt=1;
...
<table class="table mb-0">
 <thead>
            ...
            $ret=mysqli_query($con,"select tbldocument.ID as docid,tbladmapplications.CourseApplied,tbladmapplications.ID as apid,tbladmapplications.AdminStatus, tbluser.FirstName,tbluser.LastName,
            tbluser.MobileNumber,tbluser.Email from  tbladmapplications inner join tbluser on tbluser.ID=tbladmapplications.UserId  left join 
            tbldocument on tbldocument.UserId=tbladmapplications.UserID where tbladmapplications.Section='HUMSS 12-B'");
            $cnt=1;
            while ($row=mysqli_fetch_array($ret)) {
            ?>
                <tr>
...
<table class="table mb-0">
 <thead>
            ...
            $ret=mysqli_query($con,"select tbldocument.ID as docid,tbladmapplications.CourseApplied,tbladmapplications.ID as apid,tbladmapplications.AdminStatus, tbluser.FirstName,tbluser.LastName,
            tbluser.MobileNumber,tbluser.Email from  tbladmapplications inner join tbluser on tbluser.ID=tbladmapplications.UserId  left join 
            tbldocument on tbldocument.UserId=tbladmapplications.UserID where tbladmapplications.Section='HUMSS 12-C'");
            $cnt=1;
            while ($row=mysqli_fetch_array($ret)) {
            ?>
                <tr>
