...
<head>
  <title>MRTHS || Update User Profile</title>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>First Name                   </h5>
   ...
   <input class="form-control white_bg" id="firstname" name="firstname" value="<?php  echo decryptthis($row['FirstName'], $key);?>" type="text" required>
    </div>
</fieldset>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Last Name                 </h5>
   ...
   <input class="form-control white_bg" id="lastname" name="lastname" value="<?php  echo decryptthis($row['LastName'], $key);?>"  type="text" required>
                          </div>
                        </fieldset>
                      </div>
                    </div>
