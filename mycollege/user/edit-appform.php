...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update tbladmapplications set CourseApplied='$coursename',FatherName='$fathername',MotherName='$mothername',DOB='$dob',Nationality='$nationality',Gender='$gender',Category='$category',CorrespondenceAdd='$coradd',PermanentAdd='$peradd',SSchoolAttended='$secboard',SYear='$secyop',SGradeAttended='$secper',SCompleted='$secstream',FSchoolAttended='$ssecboard',FYear='$ssecyop',FGradeAttended='$ssecper',FCompleted='$ssecstream',CSchoolAttended='$grauni',CYear='$grayop',CGradeAttended='$graper',CCompleted='$grastream',Signature='$sign' where ID='$eid' && UserId='$uid'");
    if ($query) {
...
<head>
  <title>MARTMHS || Addmission Form</title>
  ...
  <h5>Course Applied                   </h5>
   ...
   <select name='coursename' id="coursename" class="form-control white_bg">
     <option value="<?php echo $row['CourseApplied'];?>"><?php echo $row['CourseApplied'];?></option>
      <?php $query=mysqli_query($con,"select * from tblgradelevels");
...
<td>   <input class="form-control white_bg" id="10thboard" name="10thboard" placeholder="Board / University"  type="text" required='true' value="<?php echo $row['SSchoolAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="10thpyeaer" name="10thpyear" placeholder="Year"  type="text" required='true' value="<?php echo $row['SYear'];?>"></td>
<td>   <input class="form-control white_bg" id="10thpercentage" name="10thpercentage" placeholder="Percentage"  type="text" required='true' value="<?php echo $row['SGradeAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="10thstream" name="10thstream" placeholder="Stream"  type="text" required='true' value="<?php echo $row['SCompleted'];?>"></td>
</tr>
<tr>
<th>Elementary (Finished)</th>
<td>   <input class="form-control white_bg" id="12thboard" name="12thboard" placeholder="Board / University"  type="text" required='true' value="<?php echo $row['FSchoolAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="12thboard" name="12thpyear" placeholder="Year"  type="text" required='true' value="<?php echo $row['FYear'];?>"></td>
<td>   <input class="form-control white_bg" id="12thpercentage" name="12thpercentage" placeholder="Percentage"  type="text" required='true' value="<?php echo $row['FGradeAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="12thstream" name="12thstream" placeholder="Stream"  type="text" required='true' value="<?php echo $row['FCompleted'];?>"></td>
</tr>
<tr>
<th>Current Grade Level</th>
<td>   <input class="form-control white_bg" id="graduation" name="graduation" placeholder="Board / University"  type="text" value="<?php echo $row['CSchoolAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="graduationpyeaer" name="graduationpyeaer" placeholder="Year"  type="text" value="<?php echo $row['CYear'];?>"></td>
<td>   <input class="form-control white_bg" id="graduationpercentage" name="graduationpercentage" placeholder="Percentage"  type="text" value="<?php echo $row['CGradeAttended'];?>"></td>
<td>   <input class="form-control white_bg" id="graduationstream" name="graduationstream" placeholder="Stream"  type="text" value="<?php echo $row['CCompleted'];?>"></td>
</tr>
</table>
</div>
</div>
