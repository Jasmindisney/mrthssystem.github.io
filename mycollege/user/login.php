...
data-open="click" data-menu="vertical-menu" data-col="1-column">
 <nav>
            ...
            <ul class="menu" style="border-radius: 5px;">
                ...
                <li><a href="../index.php">Strands</a></li>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="" name="login"  method="post">  
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" name="emailcont" id="email" class="form-control input-lg" placeholder="Registered Email ex: test@gmail.com"
                      required="true" >
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <p style="color:white;">Copyright (C) - 2021 | Developed By CS D2019 </a> </p>
    </p>
  </footer>
