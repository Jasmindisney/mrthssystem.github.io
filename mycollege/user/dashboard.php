...
$key = 'jmnants';
function encryptthis($data, $key = 'jmnants') {
  $encryption_key = base64_decode($key = 'jmnants');
  $iv = openssl_random_pseudo_bytes(openssl_cipher_iv_length('aes-256-cbc'));
  $encrypted = openssl_encrypt($data, 'aes-256-cbc', $encryption_key, 0, $iv);
  return base64_encode($encrypted . '::' . $iv);
}
$key = 'jmnants';
function decryptthis($data, $key = 'jmnants') {
  $encryption_key = base64_decode($key = 'jmnants');
...
$name=  decryptthis($row['FirstName'], $key='jmnants');
?>
            ...
            <div class="card pull-up">
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h4 align="center">You have not applied for admision. Please fill the admission form.</h4>
                    </div>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
                    </div>
            ...
            <div class="card pull-up">
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h4 align="center">Your Application has been  selected and documents also uploaded</h4>
                    </div>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
                    </div>
