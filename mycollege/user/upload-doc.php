...
{
$tc=($tc).$extensiontc;
$tm=($tenmarksheet).$extensiontm;
$twm=($twlevemaksheet).$extensiontwm;
$gra=($gramarksheet).$extensiongra;
$pgra=($pgmarksheet).$extensionpgra;
    ...
    $query=mysqli_query($con,"insert into tbldocument(UserID,Goodmoral,Birthcertificate,Diploma,Form137,Form138) value('$uid','$tc','$tm','$twm','$gra','$pgra')");
    if ($query) {
...
<head>
  <title>MARTMHS || Upload Documents</title>
...
<tr>
  <th>Goodmoral</th>
  <td><a href="userdocs/<?php echo $row['Goodmoral'];?>" target="_blank">View File </a></td>
</tr>
<tr>
  <th>NSO/PSA Birthcertificate</th>
  <td><a href="userdocs/<?php echo $row['Birthcertificate'];?>" target="_blank">View File </a></td>
</tr>
<tr>
  <th>Grade 6 or Grade 10 Diploma</th>
  <td><a href="userdocs/<?php echo $row['Diploma'];?>" target="_blank">View File </a></td>
</tr>
<tr>
  <th>Form 137</th>
  <td>
    <a href="userdocs/<?php echo $row['Form137'];?>" target="_blank">View File </a>
  </td>
</tr>
<tr>
  <th>Form 138</th>
...
<?php if($row['Form138']==""){ ?>
  NA
<?php } else{ ?>
    <a href="userdocs/<?php echo $row['Form138'];?>" target="_blank">View File </a>
<?php } ?>
  </td>
</tr>
</table>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>NSO/PSA Birthcertificate</h5>
   <div class="form-group">
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>Grade 6 or Grade 10 Diploma</h5>
   <div class="form-group">
